---
layout: post
title: Sério, um blog em 2023?
date: 2023-06-29 17:09:00 -0300
categories:
  - escritos
  - tecnologia
image: /assets/images/2023-06/paperboy-1024x1024.jpg
tags:
  - blog
  - pessoal
  - rss
...
Neste 2023, acredito que pouca gente visita blogs periodicamente. Então dá pra acompanhar também por e-mail. Criei dois tipos de newsletter: uma que envia todos os textos assim que eles são publicados e a outra semanal, com um resumo do blog. Se tiver interesse, [cadastre-se aqui](https://divagar.blog/newsletters/). Além disso, dá pra acompanhar também pelo [bom e velho RSS](https://manualdousuario.net/como-usar-feeds-rss/). Joguei os links dos primeiros textos no [Mastodon](http://urbanists.social/@benicchio) e também no [Linkedin](https://www.linkedin.com/in/thiago-benicchio/), mas a tendência é não replicar muita coisa por lá.

Em 2005, quando botei no ar o [apocalipse motorizado](https://www.apocalipsemotorizado.net/), blogs eram novidade, uma sequência natural da utopia libertadora da internet pré-algoritmo. Minha motivação era simplesmente escrever. Naquela época estava recém formado em jornalismo, engajado no questionamento da [carrocracia](https://youtu.be/Ia-wGfDtsNg) e na [Bicicletada](https://web.archive.org/web/20090108162205/http://www.bicicletada.org/tiki-index.php). Montei o blog pois achei que era uma boa forma de tratar do que a mídia não tratava ("odeia a mídia, seja a mídia", como dizia o [Centro de Mídia Independente](https://pt.wikipedia.org/wiki/Centro_de_M%C3%ADdia_Independente)).
...
Tinha alguns requisitos ao escolher a ferramenta de publicação: ser dono do conteúdo, ter autonomia para alguns ajustes e não estar debaixo de nenhum guarda-chuva "gratuito" onde eu seria o produto. Me indicaram algumas ferramentas livres ou abertas como [noblogs](https://noblogs.org/), [Hugo](https://gohugo.io/) e outras, mas a minha força de nerd foi diminuindo com o passar dos anos e eu não estava muito afim de grandes configurações.
